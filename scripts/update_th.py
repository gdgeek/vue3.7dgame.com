...
th_content = """export default {
    ...
    page: {
      ...
      list: {
        ...
        toolbar: {
          ...
          dialogSubmit: "ตกลง",
          confirm: {
            message1: "การดำเนินการนี้จะลบ【ฉาก】อย่างถาวร ต้องการดำเนินการต่อหรือไม่?",
            message2: "แจ้งเตือน",
            confirm: "ยืนยัน",
            cancel: "ยกเลิก",
            success: "ลบสำเร็จ!",
  ...
  manager: {
    ...
    list: {
      ...
      confirm: {
        message1: "การดำเนินการนี้จะลบผู้ใช้นี้อย่างถาวร ต้องการดำเนินการต่อหรือไม่?",
        message2: "แจ้งเตือน",
        confirm: "ยืนยัน",
        cancel: "ยกเลิก",
        success: "ลบสำเร็จ!",
  ...
  imageSelector: {
    ...
    invalidImageType: "รูปภาพที่อัปโหลดต้องเป็นรูปแบบ JPG/PNG/BMP/GIF เท่านั้น!",
...
with open("src/lang/package/th.ts", "w", encoding="utf-8") as f:
    f.write(th_content)

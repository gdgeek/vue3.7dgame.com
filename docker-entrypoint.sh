...
#   APP_API_3_WEIGHT=10
#   APP_AUTH_1_URL=https://identity.d.xrteeth.com
#   APP_AUTH_2_URL=https://identity.d.tmrpp.com
...
VITE_APP_WECHAT_AUTH_API_JSON=$(json_encode "${VITE_APP_WECHAT_AUTH_API:-${WECHAT_AUTH_API:-}}")
IDENTITY_OIDC_BRIDGE_ENABLED_JSON=$(json_encode "${IDENTITY_OIDC_BRIDGE_ENABLED:-${VITE_IDENTITY_OIDC_BRIDGE_ENABLED:-}}")
IDENTITY_OIDC_CLIENT_ID_JSON=$(json_encode "${IDENTITY_OIDC_CLIENT_ID:-${VITE_IDENTITY_OIDC_CLIENT_ID:-}}")
IDENTITY_OIDC_REDIRECT_URI_JSON=$(json_encode "${IDENTITY_OIDC_REDIRECT_URI:-${VITE_IDENTITY_OIDC_REDIRECT_URI:-}}")
...
EOF
echo "[entrypoint] Runtime env: BLOCKLY_URL=${APP_BLOCKLY_URL:-<not set>}, EDITOR_URL=${APP_EDITOR_URL:-<not set>}, AUTH_PROVIDER=${AUTH_PROVIDER:-<not set>}, VITE_AUTH_PROVIDER=${VITE_AUTH_PROVIDER:-<not set>}, VITE_APP_AUTH_API=${VITE_APP_AUTH_API:-<not set>}, VITE_APP_WECHAT_AUTH_API=${VITE_APP_WECHAT_AUTH_API:-${WECHAT_AUTH_API:-<not set>}}, IDENTITY_OIDC_BRIDGE_ENABLED=${IDENTITY_OIDC_BRIDGE_ENABLED:-${VITE_IDENTITY_OIDC_BRIDGE_ENABLED:-<not set>}}"
echo "[entrypoint] Unity runtime: built-in /webgl-preview/active.json"

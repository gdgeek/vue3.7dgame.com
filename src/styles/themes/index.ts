...
const deepSpaceStyle: StyleVariables = {
  ...
  sidebarBg: 'var(--bg-sidebar)',
  sidebarGradient: 'linear-gradient(180deg, rgba(45, 104, 255, 0.03) 0%, transparent 100%)',
  
  cardHoverTransform: 'translateY(-2px)',
  cardHoverShadow: '0 12px 32px rgba(0, 0, 0, 0.4), 0 0 0 1px rgba(45, 104, 255, 0.1)',
...
const techStyle: StyleVariables = {
  ...
  shadowSmall: '0 0 8px rgba(0, 242, 255, 0.15), inset 0 0 0 1px rgba(0, 242, 255, 0.1)',
  shadowMedium: '0 0 20px rgba(0, 242, 255, 0.2), inset 0 0 0 1px rgba(0, 242, 255, 0.15)',
  shadowLarge: '0 0 40px rgba(0, 242, 255, 0.25), inset 0 0 0 1px rgba(0, 242, 255, 0.2)',
  ...
  sidebarBg: 'var(--bg-sidebar)',
  sidebarGradient: 'linear-gradient(180deg, rgba(0, 242, 255, 0.03) 0%, transparent 100%)',
  
  cardHoverTransform: 'translateY(-2px)',
  cardHoverShadow: '0 0 35px rgba(0, 242, 255, 0.35), inset 0 0 0 1px rgba(0, 242, 255, 0.3)',
...
const eduStyle: StyleVariables = {
  ...
  fontFamily: '"Nunito", "Comic Neue", "Noto Sans SC", -apple-system, sans-serif',
  fontSizeXs: '13px',
  fontSizeSm: '14px',
  fontSizeMd: '15px',
  fontSizeLg: '17px',
  ...
  sidebarBg: 'var(--bg-sidebar)',
  sidebarGradient: 'linear-gradient(180deg, rgba(255, 107, 53, 0.05) 0%, rgba(255, 183, 77, 0.05) 100%)',
...
const brutalismStyle: StyleVariables = {
  ...
  fontFamily: '"Lexend", "Space Grotesk", "Noto Sans SC", -apple-system, sans-serif',
  fontSizeXs: '13px',
  fontSizeSm: '14px',
  fontSizeMd: '15px',
  fontSizeLg: '18px',
...
export function generateModernColors(primaryColor: string): ColorVariables {
  ...
  // 生成 hover 色（稍暗）
  const darken = (value: number, amount: number) => Math.max(0, Math.min(255, Math.round(value * (1 - amount))))
...
const deepSpaceColors: ColorVariables = {
  ...
  bgSidebarGradient: 'linear-gradient(180deg, rgba(45, 104, 255, 0.02) 0%, transparent 100%)',
...
const cyberNeonColors: ColorVariables = {
  ...
  bgCardGradient: 'linear-gradient(135deg, rgba(0, 242, 255, 0.03) 0%, rgba(157, 0, 255, 0.02) 100%)',
  bgHover: 'rgba(0, 242, 255, 0.08)',
  bgActive: 'rgba(0, 242, 255, 0.15)',
  bgSidebar: 'rgba(11, 14, 20, 0.95)',
  bgSidebarGradient: 'linear-gradient(180deg, rgba(0, 242, 255, 0.04) 0%, transparent 60%)',
...
const eduOrangeColors: ColorVariables = {
  ...
  bgCard: '#ffffff',
  bgCardGradient: 'linear-gradient(135deg, rgba(255, 107, 53, 0.02) 0%, rgba(255, 183, 71, 0.02) 100%)',
  bgHover: '#FFF0EB',
  bgActive: '#FFE4DB',
  bgSidebar: '#ffffff',
  bgSidebarGradient: 'linear-gradient(180deg, rgba(255, 107, 53, 0.08) 0%, rgba(255, 183, 71, 0.04) 100%)',

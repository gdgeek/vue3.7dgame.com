  ...
  <div class="array-field">
    <div v-for="(item, index) in modelValue" :key="index" class="array-item">
      ...
      <div class="item-content">
        ...
        <SchemaField v-model="modelValue[index]" :schema="schema.items" :prop-key="String(index)"
...
const getDefaultValue = (itemSchema: any) => {
  if (itemSchema.default !== undefined) return JSON.parse(JSON.stringify(itemSchema.default));

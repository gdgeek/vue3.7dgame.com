...
export default {
  manager: {
    ...
    ui: {
      ...
      schoolDetail: "รายละเอียดโรงเรียน",
      teacherDetail: "รายละเอียดครู",
      studentDetail: "รายละเอียดนักเรียน",
      removeFromSchool: "นำออกจากโรงเรียน",
      schoolName: "ชื่อโรงเรียน",
      createdDate: "วันที่สร้าง",
      affiliatedSchool: "โรงเรียนที่สังกัด",
      currentClass: "ชั้นเรียนปัจจุบัน",
      studentName: "ชื่อนักเรียน",
      teacherName: "ชื่อครู",
      noSchools: "ยังไม่มีโรงเรียน",
      noStudents: "ยังไม่มีนักเรียน",
      noTeachers: "ยังไม่มีครู",
      createSchoolPending:
        "ฟังก์ชันสร้างโรงเรียนยังไม่พร้อมใช้งาน (โปรดใช้ระบบหลังบ้านเดิม)",
      addStudentPending: "ฟังก์ชันเพิ่มนักเรียนยังไม่พร้อมใช้งาน",
  ...
  phototype: {
    ...
    edit: {
      ...
      name: "ชื่อ",
      enterName: "กรุณาใส่ชื่อต้นแบบ",
      type: "ประเภท",
      enterType: "กรุณาใส่ประเภท",

...
export default {
  verse: {
    ...
    listPage: {
      ...
      loadedEntities: "เอนทิตีที่โหลดแล้ว",
      noLoadedEntities: "ยังไม่มีเอนทิตีที่โหลด",
      entityFallback: "เอนทิตี#",
      enterEntity: "ไปยังเอนทิตีนี้",
    ...
    view: {
      ...
      sceneEditor: {
        ...
        saveCurrentAndPublishConfirm:
          "ต้องการบันทึกฉากปัจจุบันและเผยแพร่หรือไม่?",
        publishFailed: "เผยแพร่ฉากไม่สำเร็จ โปรดลองอีกครั้ง",

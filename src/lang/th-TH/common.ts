...
export default {
  common: {
    editorLoading: {
      progressLabel: "ความคืบหน้าการโหลดทรัพยากร",
      count: "เสร็จแล้ว {completed} / {total} รายการ",
      workFailed: "โหลดไม่สำเร็จ กรุณาโหลดใหม่",
      stages: {
        connecting: "กำลังเชื่อมต่อเครื่องมือแก้ไข",
        data: "กำลังอ่านข้อมูลฉาก / เอนทิตี",
        initializing: "กำลังเริ่มต้นเครื่องมือแก้ไข",
        assets: "กำลังโหลดทรัพยากร",
        finishing: "กำลังเตรียมฉากและสถานะการแก้ไข",
        ready: "โหลดเสร็จแล้ว",
        error: "โหลดล้มเหลว",
        model: "กำลังโหลดโมเดล",
        module: "กำลังโหลดเอนทิตีในฉาก",
        anchor: "กำลังโหลดจุดยึด",
        space: "กำลังโหลดพื้นหลังเชิงพื้นที่",
      },
    ...
    unityPreview: {
      entry: "รันฉาก",
      title: "รันฉาก",
      helpClick: "คลิกที่ภาพก่อนเพื่อให้พื้นที่แสดงฉากรับโฟกัส",
      helpRotate:
        "กด Alt (⌥ Option บน Mac) ค้างไว้ แล้วลากด้วยปุ่มซ้ายของเมาส์เพื่อหมุนมุมมอง",
      helpZoomPan:
        "ใช้ล้อเมาส์หรือเลื่อนสองนิ้วบนแทร็กแพดเพื่อซูม และลากด้วยปุ่มขวาของเมาส์เพื่อเลื่อนมุมมอง",

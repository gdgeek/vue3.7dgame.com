...
export default {
  common: {
    ...
    scriptDraft: {
      ...
      statusSaving: "保存中",
      statusSaved: "保存済み",
      statusAutoSaved: "自動保存済み",
      statusDirty: "未保存",
      versionList: "履歴バージョン",
      empty: "履歴バージョンはまだありません",
      clearHistory: "履歴をクリア",
      restore: "このバージョンに戻す",
      restoreSuccess:
        "選択したバージョンに戻しました。確認して保存してください。",
      autoSavedNotice: "自動保存しました",
      autoTag: "自動保存",
      manualTag: "手動保存",
      emptySummary: "内容なし",
      summaryAdded: "{items} を追加",
      summaryRemoved: "{items} を削除",
  ...
  ui: {
    ...
    paginationPrefix: "第",
    paginationSuffix: "ページ / 全 {total} ページ",

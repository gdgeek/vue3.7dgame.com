...
export default {
  "voxel": {
    ...
    "initializingModelProgress": "ボクセル {current}/{total} ({percentage}%) を初期化中...",
  ...
  "picture": {
    ...
    "initializingModelProgress": "画像 {current}/{total} ({percentage}%) を初期化中...",
  ...
  "video": {
    ...
    "initializingModelProgress": "ビデオ {current}/{total} ({percentage}%) を初期化中...",
  ...
  "audio": {
    ...
    "initializingModelProgress": "音声 {current}/{total} ({percentage}%) を初期化中...",
  ...
  "particle": {
    ...
    "initializingModelProgress": "特效 {current}/{total} ({percentage}%) を初期化中...",

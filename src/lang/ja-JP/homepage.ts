...
export default {
  "homepage": {
    ...
    "edit": {
      ...
      "return": "個人センターに戻る",
      "userNickname": "ユーザー名",
      "userNicknameStatement": "MrPPコミュニティの他のユーザーがあなたを認識しやすくします。",
      "nickname": "ニックネーム",
      "confirm": "確認",
      "avatar": "アバター",
      "avatarStatement": "最大サイズ 2 MB。JPG、GIF、PNG。",
      "basicInformation": "基本情報",
      "basicInformationStatement": "基本情報を入力して、より楽しいパーソナライズされた体験を得てください。",
      "gender": "性別",
      "man": "男性",
      "woman": "女性",
      "industry": "業界",
      ...
      "avatarCropping": {
        ...
        "cancel": "キャンセル",
        "confirm": "確認",
        "error1": "アップロードされたアバター画像はJPG/PNG/BMP/GIF形式である必要があります！",
        "error2": "アップロードされたアバター画像のサイズは2MBを超えてはなりません！",
      ...
      "rules": {
        "nickname": {
          ...
          "error2": "ニックネームは中国語、アルファベット、数字、アンダースコアのみをサポートしています",

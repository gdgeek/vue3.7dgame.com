<template>
  <div :class="{ 'dark-theme': isDark }">
    <!-- 引入Hero组件 -->
    <EducationHero @openLogin="openLoginDialog" />

    <!-- 引入AR教育解决方案组件 -->
    <AREducationSolutions @openLogin="openLoginDialog" />

    <!-- 引入AR教育应用场景组件 -->
    <AREducationScenes @openLogin="openLoginDialog" />
  </div>
</template>
...
import EducationHero from './components/EducationHero.vue';
import AREducationSolutions from './components/AREducationSolutions.vue';
import AREducationScenes from './components/AREducationScenes.vue';

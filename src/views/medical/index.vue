<template>
  <div class="app-container" :class="{ 'dark-theme': isDark }">
    ...
    <div class="content-container" ref="contentRef" :class="{ 'dark-theme': isDark }">
      ...
      <MedicalHero v-if="isIndex" @openLogin="openLoginDialog" />
...
const navMenuItems = [
  ...
  { key: "xr-solutions", label: "XR牙科创新", path: "/medical/ar-solutions" },
  { key: "dental-cases", label: "3D牙科应用", path: "/medical/dental-cases" },
];
...
// 自动滚动
const SCROLL_POSITION_KEY = 'medical_scroll_position';
